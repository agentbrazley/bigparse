...
exports.checkAndElicitLSP = checkAndElicitLSP;
exports.createElicitationPrompt = createElicitationPrompt;
const language_servers_js_1 = require("../resources/language-servers.js");
async function checkAndElicitLSP(language) {
    // Check if the language server is installed
    const isInstalled = await (0, language_servers_js_1.checkLanguageServer)(language);
    if (isInstalled) {
...
function createElicitationPrompt(elicitation) {
    return `
...
//# sourceMappingURL=lsp-check.js.map